...
public:
    ...
    template <class T> void Add(T item) {
        ...
        /*
         * mpBuffer+mLength指向的是mpBuffer数组的未被使用的第一个位置
         * 所以这个语句的功能是把item的内容拷贝到mpBuffer的合适位置
         * 并修改指示器mLength,mBackOffset的值
         */
...
private:
    size_t mBlockSize;	//
    size_t mSize;		//表示mpBuffer的总容量  2016.06.08
    size_t mLength;		//表示mpBuffer中已经使用的大小  2016.06.08
    size_t mOffset;
    size_t mBackOffset;
    char * mpBuffer;	//用来存数据的缓冲区  2016.06.08
    bool mOwnBuffer;
};
