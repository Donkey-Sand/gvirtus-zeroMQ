...
//testing vpelliccia
extern "C" __host__ cudaError_t CUDARTAPI cudaIpcGetMemHandle (cudaIpcMemHandle_t* handle, void* devPtr) {
    CudaRtFrontend::Prepare();
...
extern "C" __host__ cudaError_t CUDARTAPI cudaIpcGetEventHandle ( cudaIpcEventHandle_t* handle, cudaEvent_t event ) {
    CudaRtFrontend::Prepare();
    CudaRtFrontend::AddHostPointerForArguments(handle);
...
extern "C" __host__ cudaError_t CUDARTAPI cudaIpcOpenEventHandle(cudaEvent_t *event, cudaIpcEventHandle_t handle) {
    CudaRtFrontend::Prepare();
...
extern "C" __host__ cudaError_t CUDARTAPI cudaIpcOpenMemHandle( void** devPtr, cudaIpcMemHandle_t handle, unsigned int  flags )
 {
    CudaRtFrontend::Prepare();
    CudaRtFrontend::AddVariableForArguments(handle);
    CudaRtFrontend::AddVariableForArguments(flags);
...
extern "C" __host__ cudaError_t CUDARTAPI cudaDeviceEnablePeerAccess (int  peerDevice, unsigned int  flags )
 {
    CudaRtFrontend::Prepare();
...
extern "C" __host__ cudaError_t CUDARTAPI cudaDeviceCanAccessPeer(int *canAccessPeer, int device, int peerDevice) {
    CudaRtFrontend::Prepare();
...
extern "C" __host__ cudaError_t CUDARTAPI cudaDeviceGetStreamPriorityRange ( int* leastPriority, int* greatestPriority ) {
    CudaRtFrontend::Prepare();
